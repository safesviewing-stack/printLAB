...
async function initAuth() {
  ...
  if (tokenStr) {
    try {
      ...
      if (sessionUser) {
        ...
        // ------------------------------------------------
        const cachedName =
          localStorage.getItem("printlab_cached_name") ||
  ...
  if (authButtons) {
    authButtons.innerHTML = `
      <a
        ...
        class="btn-auth light"
        onclick="localStorage.removeItem('sb-jmwprzgfdkphbxryjbnr-auth-token');"
      >
        Iniciar Sesión
      </a>
      <a
    ...
    if (headerRegLink) {
      ...
      let redir =
        ...
        sessionStorage.getItem("printlab_auth_redirect") ||
        "../index.html";
  ...
  if (currentPathname.includes("informe-stl")) {
    const redirect = encodeURIComponent("informe-stl.html");
    window.location.href = pathPrefix + "login.html?redirect=" + redirect;
  } else if (currentPathname.includes("analizador-stl")) {
    const redirect = encodeURIComponent("analizador-stl.html");
    window.location.href = pathPrefix + "login.html?redirect=" + redirect;
  }
}
